// Generate an image with the mandelbrot set.
// The output is an image in PPM format.
//
// Usage:
//    Mandelbrot > output.ppm
// The file output.ppm can be viewed with standard image viewers.
//
class Mandelbrot {
